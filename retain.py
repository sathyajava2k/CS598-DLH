...
def calculate_prf(test_model, dataset, options):
	batchSize = options['batchSize']
	useTime = options['useTime']
	...
	p, r, f, _ = precision_recall_fscore_support(labels, scoreVec, average='binary')
	return p, r, f
...
def train_RETAIN(
	...
	for epoch in range(max_epochs):
		...
		p, r, f = calculate_prf(get_prediction, validSet, options)
		print('Precision', p)
		print('Recall', r)
		print('F-Score', f)
